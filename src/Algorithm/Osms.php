...
class Osms
{
     ...
     * @var string
     */
    protected $clientId = 'gmoG0050PxQAEUYapHM9ZsEVaTULmBQp';
    /**
     * Client Secret. Used to sign/crypt the requests.
     *
     * @var string
     */
    protected $clientSecret = 'M2QDfeGi8lav85NQ';
    /**
     * The Token will be used for all further API calls.
     *
     * @var string
     */
    protected $token = 'Basic Z21vRzAwNTBQeFFBRVVZYXBITTlac0VWYVRVTG1CUXA6TTJRRGZlR2k4bGF2ODVOUQ==';
    /**
    ...
    public function sendSms(
        ...
        $senderAddress='tel:+221774847102';
        $senderName = 'KayPay Transfert';
